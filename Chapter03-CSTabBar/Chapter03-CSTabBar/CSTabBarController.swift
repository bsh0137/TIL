...
class CSTabBarController: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        // 새로운 탭 바 역할을 할 뷰를 위해 기준 좌표와 크기를 정함.
        ...
        self.addTabBarBtn(btn: self.tabItem02, title: "첫 번째 버튼", tag: 1)
        self.addTabBarBtn(btn: self.tabItem03, title: "첫 번째 버튼", tag: 2)
        
        // 처음에 첫 번째 탭이 선택되어 있도록 초기 상태를 정의해 줌.
